...
entry:
  ...
  store i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)* @foo, i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)** %goo_ptr, align 8, !dbg !70
...
if.then:                                          ; preds = %entry
  %1 = load i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)*, i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)** %goo_ptr, align 8, !dbg !77
  %2 = load i32, i32* %op1.addr, align 4, !dbg !79
  %3 = load i32, i32* %op2.addr, align 4, !dbg !80
  %4 = load i32 (i32, i32)*, i32 (i32, i32)** %a_fptr, align 8, !dbg !81
  %5 = load i32 (i32, i32)*, i32 (i32, i32)** %s_fptr, align 8, !dbg !82
  %call = call i32 (i32, i32)* %1(i32 %2, i32 %3, i32 (i32, i32)* %4, i32 (i32, i32)* %5), !dbg !77
  store i32 (i32, i32)* %call, i32 (i32, i32)** %t_fptr, align 8, !dbg !83
  br label %if.end, !dbg !84

if.else:                                          ; preds = %entry
  store i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)* @clever, i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)** %goo_ptr, align 8, !dbg !85
  %6 = load i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)*, i32 (i32, i32)* (i32, i32, i32 (i32, i32)*, i32 (i32, i32)*)** %goo_ptr, align 8, !dbg !87
  %7 = load i32, i32* %op1.addr, align 4, !dbg !88
  %8 = load i32, i32* %op2.addr, align 4, !dbg !89
  %9 = load i32 (i32, i32)*, i32 (i32, i32)** %s_fptr, align 8, !dbg !90
  %10 = load i32 (i32, i32)*, i32 (i32, i32)** %a_fptr, align 8, !dbg !91
  %call2 = call i32 (i32, i32)* %6(i32 %7, i32 %8, i32 (i32, i32)* %9, i32 (i32, i32)* %10), !dbg !87
  store i32 (i32, i32)* %call2, i32 (i32, i32)** %t_fptr, align 8, !dbg !92
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %11 = load i32 (i32, i32)*, i32 (i32, i32)** %t_fptr, align 8, !dbg !93
  %12 = load i32, i32* %op1.addr, align 4, !dbg !94
  %13 = load i32, i32* %op2.addr, align 4, !dbg !95
  %call3 = call i32 %11(i32 %12, i32 %13), !dbg !93
  ret i32 0, !dbg !96
}
...
!20 = distinct !DISubprogram(name: "minus", scope: !1, file: !1, line: 6, type: !8, isLocal: false, isDefinition: true, scopeLine: 6, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!21 = !DILocalVariable(name: "a", arg: 1, scope: !20, file: !1, line: 6, type: !10)
!22 = !DILocation(line: 6, column: 15, scope: !20)
!23 = !DILocalVariable(name: "b", arg: 2, scope: !20, file: !1, line: 6, type: !10)
...
!29 = distinct !DISubprogram(name: "foo", scope: !1, file: !1, line: 10, type: !30, isLocal: false, isDefinition: true, scopeLine: 10, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!30 = !DISubroutineType(types: !31)
!31 = !{!32, !10, !10, !32, !32}
!32 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !8, size: 64)
!33 = !DILocalVariable(name: "a", arg: 1, scope: !29, file: !1, line: 10, type: !10)
!34 = !DILocation(line: 10, column: 15, scope: !29)
!35 = !DILocalVariable(name: "b", arg: 2, scope: !29, file: !1, line: 10, type: !10)
!36 = !DILocation(line: 10, column: 22, scope: !29)
!37 = !DILocalVariable(name: "a_fptr", arg: 3, scope: !29, file: !1, line: 10, type: !32)
!38 = !DILocation(line: 10, column: 31, scope: !29)
!39 = !DILocalVariable(name: "b_fptr", arg: 4, scope: !29, file: !1, line: 10, type: !32)
...
!54 = distinct !DISubprogram(name: "moo", scope: !1, file: !1, line: 16, type: !55, isLocal: false, isDefinition: true, scopeLine: 16, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!55 = !DISubroutineType(types: !56)
!56 = !{!10, !57, !10, !10}
!57 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!58 = !DILocalVariable(name: "x", arg: 1, scope: !54, file: !1, line: 16, type: !57)
!59 = !DILocation(line: 16, column: 14, scope: !54)
!60 = !DILocalVariable(name: "op1", arg: 2, scope: !54, file: !1, line: 16, type: !10)
!61 = !DILocation(line: 16, column: 21, scope: !54)
!62 = !DILocalVariable(name: "op2", arg: 3, scope: !54, file: !1, line: 16, type: !10)
!63 = !DILocation(line: 16, column: 30, scope: !54)
!64 = !DILocalVariable(name: "a_fptr", scope: !54, file: !1, line: 17, type: !32)
!65 = !DILocation(line: 17, column: 11, scope: !54)
!66 = !DILocalVariable(name: "s_fptr", scope: !54, file: !1, line: 18, type: !32)
!67 = !DILocation(line: 18, column: 11, scope: !54)
!68 = !DILocalVariable(name: "goo_ptr", scope: !54, file: !1, line: 19, type: !69)
!69 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !30, size: 64)
!70 = !DILocation(line: 19, column: 14, scope: !54)
!71 = !DILocalVariable(name: "t_fptr", scope: !54, file: !1, line: 20, type: !32)
!72 = !DILocation(line: 20, column: 11, scope: !54)
!73 = !DILocation(line: 22, column: 8, scope: !74)
!74 = distinct !DILexicalBlock(scope: !54, file: !1, line: 22, column: 8)
...
!86 = distinct !DILexicalBlock(scope: !74, file: !1, line: 26, column: 5)
