...
entry:
  ...
  store i32 (i32, i32)* (i32, i32, %struct.fptr*, %struct.fptr*)* @foo, i32 (i32, i32)* (i32, i32, %struct.fptr*, %struct.fptr*)** %goo_ptr, align 8, !dbg !92
...
if.then:                                          ; preds = %entry
  %1 = load i32 (i32, i32)* (i32, i32, %struct.fptr*, %struct.fptr*)*, i32 (i32, i32)* (i32, i32, %struct.fptr*, %struct.fptr*)** %goo_ptr, align 8, !dbg !99
  %2 = load i32, i32* %op1.addr, align 4, !dbg !101
  %3 = load i32, i32* %op2.addr, align 4, !dbg !102
  %call = call i32 (i32, i32)* %1(i32 %2, i32 %3, %struct.fptr* %a_fptr, %struct.fptr* %s_fptr), !dbg !99
  store i32 (i32, i32)* %call, i32 (i32, i32)** %t_fptr, align 8, !dbg !103
  %4 = load i32 (i32, i32)*, i32 (i32, i32)** %t_fptr, align 8, !dbg !104
  %5 = load i32, i32* %op1.addr, align 4, !dbg !105
  %6 = load i32, i32* %op2.addr, align 4, !dbg !106
  %call3 = call i32 %4(i32 %5, i32 %6), !dbg !104
  br label %if.end, !dbg !107

if.else:                                          ; preds = %entry
  store i32 (i32, i32)* (i32, i32, %struct.fptr*, %struct.fptr*)* @clever, i32 (i32, i32)* (i32, i32, %struct.fptr*, %struct.fptr*)** %goo_ptr, align 8, !dbg !108
  %7 = load i32 (i32, i32)* (i32, i32, %struct.fptr*, %struct.fptr*)*, i32 (i32, i32)* (i32, i32, %struct.fptr*, %struct.fptr*)** %goo_ptr, align 8, !dbg !110
  %8 = load i32, i32* %op1.addr, align 4, !dbg !111
  %9 = load i32, i32* %op2.addr, align 4, !dbg !112
  %call4 = call i32 (i32, i32)* %7(i32 %8, i32 %9, %struct.fptr* %s_fptr, %struct.fptr* %a_fptr), !dbg !110
  store i32 (i32, i32)* %call4, i32 (i32, i32)** %t_fptr, align 8, !dbg !113
  %10 = load i32 (i32, i32)*, i32 (i32, i32)** %t_fptr, align 8, !dbg !114
  %11 = load i32, i32* %op1.addr, align 4, !dbg !115
  %12 = load i32, i32* %op2.addr, align 4, !dbg !116
  %call5 = call i32 %10(i32 %11, i32 %12), !dbg !114
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %13 = load i32 (i32, i32)*, i32 (i32, i32)** %t_fptr, align 8, !dbg !117
  %14 = load i32, i32* %op1.addr, align 4, !dbg !118
  %15 = load i32, i32* %op2.addr, align 4, !dbg !119
  %call6 = call i32 %13(i32 %14, i32 %15), !dbg !117
  ret i32 0, !dbg !120
}
